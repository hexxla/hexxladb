...
| Date       | Scope                                                                                                      | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-24 | **v0.1.0 release**                                                                                         | Initial development release. First usable version with MVCC, encryption, WAL durability, hexagonal lattice, seams/contradictions, token-budgeted context assembly, comprehensive tests, and LLM guardrails (`.cursor/`, `.windsurf/`, `.claude/`, `.codex/`). `VERSIONING.md` updated per semver.org FAQ.                                                                                                                                                                                    |
