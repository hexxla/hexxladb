...
- [ ] Execute limitation-remediation workstream 11, confirming each completion gate before v1 readiness work is considered complete
...
- Keep completed history in `CHANGELOG.md`, not here
