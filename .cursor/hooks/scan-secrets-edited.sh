#!/usr/bin/env bash
# afterFileEdit — warn on high-signal secret patterns in the edited file (stderr only; does not block).
# Complement with git-secrets, gitleaks in CI, or partner integrations (see Cursor hooks docs).
set -euo pipefail
