#!/usr/bin/env bash
# post_write_code — warn on high-signal secret patterns in the edited file (stderr only; does not block).
# Complement with git-secrets, gitleaks in CI, or partner integrations (see Windsurf hooks docs).
set -euo pipefail
