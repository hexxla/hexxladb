...
- [ ] **Temporal Range Queries** (`temporal_range.go`) — `DB.CellsInTimeRange`: cells/seams added or changed in a wall-clock window using existing `time/` index and changelog
