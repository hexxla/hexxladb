#!/usr/bin/env bash
# UserPromptSubmit hook — block submission for very high-confidence secret patterns.
set -euo pipefail

# Claude UserPromptSubmit input: {"prompt": "..."} via stdin
# Claude expects JSON output: {"continue": true/false, "user_message": "..."}
